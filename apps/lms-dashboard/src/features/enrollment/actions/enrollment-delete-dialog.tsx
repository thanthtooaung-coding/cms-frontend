...
interface Props {
  ...
  currentRow: EnrollmentDataType;
}

export function EnrollmentDeleteDialog({ open, onOpenChange, currentRow }: Props) {
    ...
    <ConfirmDialog
      ...
      desc={
        <div className="space-y-4">
          <p className="mb-2">
            Are you sure you want to delete <span className="font-bold">{currentRow.studentName}</span>?
            <br />
