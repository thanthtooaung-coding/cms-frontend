      ...
      desc={
        <div className="space-y-4">
          <p className="mb-2">
            ...
            <br />
            This action will permanently remove the instructor from the system. This cannot be undone.
          </p>
          ...
          <Label className="my-2">
            ...
            <Input
              ...
              placeholder="Enter Instructor name to confirm deletion."
            />
          </Label>
